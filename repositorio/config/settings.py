...
AWS_ACCESS_KEY_ID = 'AKIAYNJINXX3OYWWPLT7'
AWS_SECRET_ACCESS_KEY = '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'

AWS_STORAGE_BUCKET_NAME = 'repositorio-dte'
AWS_S3_REGION_NAME = 'us-east-2'  # O tu región
AWS_S3_FILE_OVERWRITE = False
AWS_DEFAULT_ACL = None
AWS_QUERYSTRING_AUTH = False  # Para hacer los archivos públicos (sin firmas)
